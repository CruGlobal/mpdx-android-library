...
import org.mpdx.androids.library.base.api.ApiConstants.JSON_ATTR_UPDATED_IN_DB_AT
import org.mpdx.androids.library.base.model.ChangeAwareItem
import org.mpdx.androids.library.base.model.JsonApiModel
import org.mpdx.androids.library.base.model.LocalAttributes
import org.mpdx.androids.library.base.model.UniqueItem
import org.mpdx.androids.library.base.sync.model.LastSyncTime
import org.mpdx.base.sync.model.LastSyncTimeFields
import org.mpdx.utils.copyFromRealm
import org.mpdx.utils.getManagedVersionOrNull
import org.mpdx.utils.mergeWithExistingModel
import org.mpdx.utils.realm
...
abstract class BaseSyncService(private val syncDispatcher: SyncDispatcher, val jsonApiConverter: JsonApiConverter) {
    ...
    @Deprecated(
        ...
        ReplaceWith("getManagedVersionOrNull(obj)", "org.mpdx.utils.getManagedVersionOrNull")
    )
